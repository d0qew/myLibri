//
//  ChildrenLiteratureCollectionViewCell.swift
//  myLibri
//
...
class ChildrenLiteratureCollectionViewCell: UICollectionViewCell {
    static let reuseId = "ChildrenLiteratureCollectionViewCell"
